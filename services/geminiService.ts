...
const getDocTypeSpecifics = (docType: DocType): string => {
    switch (docType) {
        ...
        case DocType.NDA_ANGAJATI:
            ...
            4. Răspunderea disciplinară și patrimonială conform Codului Muncii și GDPR.`;
...
export const generateDocumentContent = async (
  ...
  try {
    ...
    return "Serviciul de redactare juridică este momentan indisponibil. Verificați conexiunea.";
  }
};
